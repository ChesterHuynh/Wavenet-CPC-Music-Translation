...
if __name__ == "__main__":
    ...
    dst = Path("/home/magjywang/Wavenet-CPC-Music-Translation/checkpoints/pretrained_musicnet_preprocessed")
    ...
    #chkpt_args[0].expName = "pretrained_musicnet_preprocessed"
