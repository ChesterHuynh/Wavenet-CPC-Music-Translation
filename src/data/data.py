...
#
# Reference: https://github.com/facebookresearch/music-translation/blob/master/src/data.py
...
class H5Dataset(data.Dataset):
    ...
    def read_h5_file(self, h5file_path):
        ...
        try:
            ...
            logger.exception(f'No dataset named {self.dataset_name} in {h5file_path}. '
